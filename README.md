...
Voform is a macOS 14+ menu-bar voice input app. By default, press **Option-Space (⌥ Space)** to start dictation, release the keys and speak, then press it again or hold **Enter** to finish and insert the transcript into the focused field.
...
During recording, press **Esc** or click **Cancel** to open a confirmation before discarding the recording. Click **Finish**, press the dictation shortcut again in toggle mode, or hold **Enter** to stop and insert text. The floating panel stays visible while listening and shows transcription progress after finishing. New recording requests are ignored while processing.
...
The unified Settings window contains recognition language and shortcut controls under **General**, and live permission status with direct System Settings links under **Privacy**.
